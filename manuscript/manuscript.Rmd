...
For a) the original versus the rescue, the median value of $p$-original was `r rr_summ$median |> round(2)` [IQR: `r rr_summ$low |> round(2)` - `r rr_summ$high|> round(2)`], and `r round(rr_summ$less_than*100)`% of the $p$-original values were less than .05.
...
Given the mix of successful and unsuccessful rescue projects, we discuss a few projects where we have speculations about why they turned out the way they did.
...
Additionally, they are also chosen non-randomly, as they have been selected for twice based on student interest -- once for the original replication and again for the rescue.
